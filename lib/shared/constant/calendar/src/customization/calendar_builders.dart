...
typedef MarkerBuilder<T> = Widget? Function(
    BuildContext context, DateTime day, bool events);
...
typedef HighlightBuilder = Widget? Function(
    BuildContext context, DateTime day, bool );

/// Class containing all custom builders for `TableCalendar`.
class CalendarBuilders<bool> {
  ...
  final SingleMarkerBuilder<bool>? singleMarkerBuilder;
  ...
  final MarkerBuilder<bool>? markerBuilder;
